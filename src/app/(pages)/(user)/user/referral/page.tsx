...
const page = () => {
  ...
  return (
    <div>
      ...
      <div>Invite your friends and get rewarded! You'll receive a 10% bonus on every user you refer. Start sharing now and watch your earnings 🚀💰</div>
      <div className='bg-[#161616] p-4 rounded-lg my-4 flex gap-4 items-center'>
        ...
        <div className="self-end"><Button variant="contained">Invite</Button></div>
      </div>
