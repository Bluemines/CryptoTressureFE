...
function useLogin() {
    _s();
    const { control, handleSubmit, reset, formState: { errors } } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
...
_s(useLogin, "pLLlu8uX0GGLhLxuK1NYH9S1RQY=", false, function() {
    return [
...
const Login = ()=>{
    ...
    const { control, handleSubmit, errors, handleLogin } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$auth$292f$login$2f$hooks$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    const [resetPassForm, setResetPassForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        newPassword: '',
        confirmPassword: ''
    });
...
_s(Login, "BftOtWDpobSvVNyxI8l4N2MOZDI=", false, function() {
    return [
...
//# sourceMappingURL=src_ad114e2a._.js.map