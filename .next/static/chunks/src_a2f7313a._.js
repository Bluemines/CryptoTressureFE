...
;
;
const FormInput = ({ name, control, label, type = "text", errors, multiline = false, rows = 4, rules, ...props })=>{
    _s();
...
const Register = ()=>{
    ...
    const { control, errors, handleSubmit, onSubmit, submitCode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$auth$292f$register$2f$hooks$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(ref || '');
...
_s(Register, "zSC953nhs1UByH7tSNBFaVT1XYc=", false, function() {
    return [
