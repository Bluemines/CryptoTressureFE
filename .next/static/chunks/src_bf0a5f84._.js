...
function useMachineManagement() {
    ...
    const { data: machines, isLoading, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$machineManagement$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMachinesApi"])());
...
_s(useMachineManagement, "98wzfXnSazyAqJlXvFcS2Om8YJ4=", false, function() {
    return [
...
function MachineManagemnt() {
    ...
    console.log("machines", machines?.data);
    const columns = [
        {
            id: "name",
            label: "User"
...
//# sourceMappingURL=src_bf0a5f84._.js.map