...
const getAllWallets = async ()=>{
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get('wallet');
    return data.data;
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
const useGetWallets = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$admin$2f$adminService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllWallets"]
    });
};
_s1(useGetWallets, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
...
const page = ()=>{
    _s();
    const { data: walletsData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$admin$2f$useAdmin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetWallets"])();
    ...
    const formattedPendingWithdrawals = walletsData?.items?.map((item)=>({
            ...
            amount: `$${item.balance}`,
            date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(item.createdAt), {
                addSuffix: true
            }),
...
_s(page, "m/BvBDql+OQ6x2fAnpUdnVbxrQ4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$admin$2f$useAdmin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetWallets"],
...
//# sourceMappingURL=src_986afb3c._.js.map