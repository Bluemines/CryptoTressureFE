...
"[project]/src/api/userDashboard/index.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "getUserDashboardStatsApi": (()=>getUserDashboardStatsApi)
});
...
;
const getUserDashboardStatsApi = ()=>({
        queryKey: [
            "user-admin"
        ],
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryFn"])(`dashboard/user_stats`)
    });
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/(pages)/(user)/user/dashboard/hooks/index.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>useUserDashboard)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$userDashboard$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/api/userDashboard/index.ts [app-client] (ecmascript)");
...
function useUserDashboard() {
    _s();
    const { data: stats, isLoading, refetch, isError: onError, isSuccess: onSuccess } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$userDashboard$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserDashboardStatsApi"])());
...
_s(useUserDashboard, "L1aQODpvW253dSOfY5QeIyUoihc=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pages$292f28$user$292f$user$2f$dashboard$2f$hooks$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/(pages)/(user)/user/dashboard/hooks/index.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const page = ()=>{
    _s();
    const { stats, formatCurrency } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pages$292f28$user$292f$user$2f$dashboard$2f$hooks$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    const statsData = [
        {
...
_s(page, "oZLu8kEu4OOXsOpKbf9Eak6GHJ8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pages$292f28$user$292f$user$2f$dashboard$2f$hooks$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
...
//# sourceMappingURL=src_f308d67a._.js.map