...
_s(useMachineManagement, "fmqvYx4DDQ0XENS8QbA8ZzbnIhA=", false, function() {
    return [
...
function AddMachineDrawer({ open, onClose }) {
    _s();
    const { control, errors, selectedImage, handleImageSelect, handleSubmit, handleAddMachine, isValid } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pages$292f28$user$292f$admin$2f$machineManagement$2f$hooks$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
...
_s(AddMachineDrawer, "IUh5M+NaGPYUuQgND0glsgkT9Yg=", false, function() {
    return [
...
//# sourceMappingURL=src_f789f492._.js.map